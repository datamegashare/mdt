...
//       (texto plano con • y 1. 2. 3.) generado por
//       lineasATextoCalendar(). Columna D sigue con HTML
//       para que la UI renderice correctamente en el panel Hoy.
//       setupHojas() y encabezado de Notas actualizados.
//
...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addItem('1b. Migrar a v5: columna Texto',      'actualizarEncabezadoNotas')
    .addSeparator()
